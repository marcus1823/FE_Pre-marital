        ...
        <div className="bg-[#F5F3EA]">
            ...
            <div className="max-w-6xl mx-auto mt-12 px-4 text-green-800 pl-10 ">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                    <QuizCard image="src/assets/popularcard1.png" title="Do I Have Relationship Anxiety Quiz" description="Relationship Anxiety feels different for everyone. It can preoccupy your mind and trigger intrusive thoughts and reactions. 'Do I Have Relationship Anxiety?' quiz to find out!" />
                    <QuizCard image="src/assets/popularcard1.png" title="Do I Have Relationship Anxiety Quiz" description="Relationship Anxiety feels different for everyone. It can preoccupy your mind and trigger intrusive thoughts and reactions. 'Do I Have Relationship Anxiety?' quiz to find out!" />
                    <QuizCard image="src/assets/popularcard1.png" title="Do I Have Relationship Anxiety Quiz" description="Relationship Anxiety feels different for everyone. It can preoccupy your mind and trigger intrusive thoughts and reactions. 'Do I Have Relationship Anxiety?' quiz to find out!" />
                    <QuizCard image="src/assets/popularcard1.png" title="Do I Have Relationship Anxiety Quiz" description="Relationship Anxiety feels different for everyone. It can preoccupy your mind and trigger intrusive thoughts and reactions. 'Do I Have Relationship Anxiety?' quiz to find out!" />
                </div>
