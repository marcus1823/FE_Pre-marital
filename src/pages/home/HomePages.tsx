...
const therapists = [
    { image: 'src/assets/theparists1.png', name: 'Nguyễn Thị Thanh Tho', rating: '5.0' },
    { image: 'src/assets/theparists1.png', name: 'Nguyễn Thị Thanh Tho', rating: '5.0' },
    { image: 'src/assets/theparists1.png', name: 'Nguyễn Thị Thanh Tho', rating: '5.0' },
    { image: 'src/assets/theparists1.png', name: 'Nguyễn Thị Thanh Tho', rating: '5.0' },
    { image: 'src/assets/theparists1.png', name: 'Nguyễn Thị Thanh Tho', rating: '5.0' }
        ...
        <div className='bg-[#F5F3EA] pb-20'>
            ...
            <div className="flex flex-col justify-center items-center min-h-screen bg-green-900 text-white text-center px-4">
                ...
                <div className="max-w-full overflow-x-auto">
                    ...
                    <p className="mt-2 text-lg whitespace-nowrap">
                        Let us accompany, listen and support your couple in the following ways.
                    </p>
                </div>
            ...
            <div className="max-w-6xl mx-auto mt-12 px-4 text-green-800 pl-20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <ReadCard image="src/assets/readcard1.png" title="Suggestions for meaningful gifts for couples on Valent..." author="TAT news" time="14/02/2025" />
                    <ReadCard image="src/assets/readcard1.png" title="Suggestions for meaningful gifts for couples on Valent..." author="TAT news" time="14/02/2025" />
                    <ReadCard image="src/assets/readcard1.png" title="Suggestions for meaningful gifts for couples on Valent..." author="TAT news" time="14/02/2025" />
                    <ReadCard image="src/assets/readcard1.png" title="Suggestions for meaningful gifts for couples on Valent..." author="TAT news" time="14/02/2025" />
                    <ReadCard image="src/assets/readcard1.png" title="Suggestions for meaningful gifts for couples on Valent..." author="TAT news" time="14/02/2025" />
            ...
            <div className="max-w-6xl mx-auto mt-12 px-4 text-green-800 pl-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                    <PopularCard image="src/assets/popularcard1.png" title="Suggestions for meaningful gifts for couples on Valent..." author="TAT news" time="14/02/2025" />
                    <PopularCard image="src/assets/popularcard1.png" title="Suggestions for meaningful gifts for couples on Valent..." author="TAT news" time="14/02/2025" />
                    <PopularCard image="src/assets/popularcard1.png" title="Suggestions for meaningful gifts for couples on Valent..." author="TAT news" time="14/02/2025" />
                    <PopularCard image="src/assets/popularcard1.png" title="Suggestions for meaningful gifts for couples on Valent..." author="TAT news" time="14/02/2025" />
                </div>
            ...
            <div className="max-w-6xl mx-auto mt-12 px-4 py-6 bg-white rounded-lg shadow-lg">
                <h3 className="text-xl font-bold text-center text-green-800 mb-10">Our Therapists</h3>
